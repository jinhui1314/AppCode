package cc.yuan.leopardkit.db;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.util.Log;

import cc.yuan.leopardkit.db.dao.DaoMaster;
import cc.yuan.leopardkit.db.dao.DaoSession;
import cc.yuan.leopardkit.db.dao.FileModelDao;
...
public class HttpDbUtil {
    ...
    public List<DownloadInfo> queryFileInfo(int type) {
        ...
        List<FileModel> data = checkNULL().modelDao.queryRaw("where type = "+type,new String[]{});
    ...
    public boolean queryIsExist(int key){
        List<FileModel> data = checkNULL().modelDao.queryRaw("where key = "+key,new String[]{});
