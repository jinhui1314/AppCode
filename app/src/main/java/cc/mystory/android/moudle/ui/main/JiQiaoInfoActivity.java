...
public class JiQiaoInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void findView() {
        ...
        url = "http://www.zhcw.com/"+getIntent().getStringExtra("linkUrl");


        generateWebView();

        UiUtils.showIndeterminateProgressDialog(this,"正在加载中...","",true);
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final Elements elements = doc.select("div[id=news_content]");
