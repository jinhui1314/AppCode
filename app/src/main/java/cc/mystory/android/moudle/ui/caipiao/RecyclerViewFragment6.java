...
public class RecyclerViewFragment6 extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    @SuppressLint("ValidFragment")
    public RecyclerViewFragment6(Context context, int busiCode) {
        this.context = context;
        this.busiCode = busiCode;
        RecyclerViewFragment6 fragment = new RecyclerViewFragment6();
