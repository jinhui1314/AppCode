...
public class RecyclerViewFragment3 extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public RecyclerViewFragment3() {
    }

    @SuppressLint("ValidFragment")
    public RecyclerViewFragment3(Context context, int busiCode) {
        this.context = context;
        this.busiCode = busiCode;
        RecyclerViewFragment3 fragment = new RecyclerViewFragment3();
