...
public class RecyclerViewFragment4 extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public RecyclerViewFragment4() {
    }

    @SuppressLint("ValidFragment")
    public RecyclerViewFragment4(Context context, int busiCode) {
        this.context = context;
        this.busiCode = busiCode;
        RecyclerViewFragment4 fragment = new RecyclerViewFragment4();
