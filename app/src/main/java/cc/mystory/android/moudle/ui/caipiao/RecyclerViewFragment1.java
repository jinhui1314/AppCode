...
public class RecyclerViewFragment1 extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public RecyclerViewFragment1() {
    }

    @SuppressLint("ValidFragment")
    public RecyclerViewFragment1(Context context, int busiCode) {
        this.context = context;
        this.busiCode = busiCode;
        RecyclerViewFragment1 fragment = new RecyclerViewFragment1();
