...
public class RecyclerViewFragment5 extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    public RecyclerViewFragment5() {
    }

    @SuppressLint("ValidFragment")
    public RecyclerViewFragment5(Context context, int busiCode) {
        this.context = context;
        this.busiCode = busiCode;
        RecyclerViewFragment5 fragment = new RecyclerViewFragment5();
