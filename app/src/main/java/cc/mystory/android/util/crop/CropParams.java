package cc.mystory.android.util.crop;
...
public class CropParams {
    ...
    public static int DEFAULT_ASPECT_X = 2;
    public static int DEFAULT_ASPECT_Y = 1;
    public static final int DEFAULT_OUTPUT = 1000;
    public static  int DEFAULT_COMPRESS_WIDTH = 640;
    public static  int DEFAULT_COMPRESS_HEIGHT = 854;
    ...
    public CropParams(Context context,int width_x,int height_y,int aspectx,int aspecty) {
        this.context = context;
        DEFAULT_ASPECT_X=aspectx;
        DEFAULT_ASPECT_Y=aspecty;
        DEFAULT_COMPRESS_WIDTH=width_x;
        DEFAULT_COMPRESS_HEIGHT=height_y;
        type = CROP_TYPE;
