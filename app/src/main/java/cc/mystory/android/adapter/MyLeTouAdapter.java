...
public class MyLeTouAdapter extends RecyclerArrayAdapter<LeTouModle> {
    private List list;
    BaseViewHolder holder1 = null;
    Context context;

    public MyLeTouAdapter(Context context) {
        super(context);
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        int layout;
        layout = R.layout.list_items_letou;

        holder1 = new MyLeTouViewHolder(parent, layout);
        return holder1;
    }
